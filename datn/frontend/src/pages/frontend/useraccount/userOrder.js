...
import { getOrderByUser, onGetAddress, onInsertAddress, onLogout } from '../../../store/actions';
          ...
          <div class="row">
            ...
            <main class="col-lg-9 col-xl-9">
              {orderItem && orderItem?.map((order, index) => {
                return <>
                  <div class="card p-4 mb-0 shadow-0 border" key={index}>
                    <div class="content-body">
                      ...
                      <div class="card border border-primary mb-4 shadow-0">
                        <div class="card-body pb-0">
                                ...
                                <div className="modal-dialog">
                                  <div className="modal-content">
                                    ...
                                    <div className="modal-body text-start p-4">
                                      <h5 className="modal-title text-uppercase mb-2" id="exampleModalLabel">{userInfo.user_email}</h5>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <p class="mb-0 text-muted">Thông tin liên hệ</p>
                              <p class="m-0">
